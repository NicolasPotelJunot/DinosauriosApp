...
export const DinoScreen = () => {
  ...
  return (
    ...
    <section className='h-screen overflow-y-auto py-5 px-10 animate__animated animate__fadeIn'>
        ...
        <img src={ dinoImage } alt={id} className="h-72 mx-auto mt-10 cursor-zoom-in hover:relative active:scale-150" />
