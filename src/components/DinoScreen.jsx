...
import { TitleDescriptionDino } from "./ui/dinoScreen/TitleDescriptionDino";
...
export const DinoScreen = () => {
  ...
  return (
    <main>
      <div className="h-screen overflow-y-auto animate__animated animate__fadeIn">
        <section className="px-6 py-20 lg:px-52">
          {/* <button
      ...
      >
        Ir a la lista
          ...
          <section className="grid">
            <div className="mb-5">
              <TitleDescriptionDino text="Descripción" />
              <p className="inline">
                {info.map((desc, index) => (
            ...
            <div className="mb-5">
              <TitleDescriptionDino text="Descubrimiento" />
            ...
            {paleobiologia && (
              <div className="mb-5">
                <TitleDescriptionDino text="Paleobiología" />
            ...
            {paleoecologia && (
              <div className="mb-5">
                <TitleDescriptionDino text="Paleoecología" />
